...
export const metadata: Metadata = {
  ...
  description: 'Mentions légales de la plateforme ANOUANZÊ ERP, éditée par IBIG SOFT (Intermark Business International Group).',
};
        ...
        <div className="prose prose-neutral max-w-none space-y-10 text-neutral-700 leading-relaxed">
          ...
          <section>
            ...
            <div className="mt-4 p-5 bg-neutral-50 rounded-xl border border-neutral-200 text-sm space-y-1">
              <p><strong>IBIG SOFT (Intermark Business International Group)</strong></p>
          ...
          <section>
            ...
            <p>Le directeur de la publication est le représentant légal de la société IBIG SOFT (Intermark Business International Group).</p>
          </section>
          ...
          <section>
            ...
            <p>L'ensemble des éléments constituant la plateforme ANOUANZÊ ERP (logo, textes, visuels, code source, base de données, architecture logicielle) sont la propriété exclusive de <strong>IBIG SOFT (Intermark Business International Group)</strong> et sont protégés par les lois en vigueur relatives à la propriété intellectuelle.</p>
            <p className="mt-3">Toute reproduction, représentation, modification, publication, adaptation ou exploitation de tout ou partie des éléments de la plateforme, sans l'autorisation écrite préalable de IBIG SOFT (Intermark Business International Group), est strictement interdite et constitue une contrefaçon.</p>
          </section>
          ...
          <section>
            ...
            <p>IBIG SOFT (Intermark Business International Group) traite les données personnelles de ses utilisateurs conformément à la réglementation en vigueur sur la protection des données personnelles, notamment la loi ivoirienne n° 2013-450 du 19 juin 2013 relative à la protection des données à caractère personnel.</p>
          ...
          <section>
            ...
            <p>IBIG SOFT (Intermark Business International Group) s'efforce de maintenir la plateforme ANOUANZÊ ERP accessible et à jour. Cependant, IBIG SOFT (Intermark Business International Group) ne saurait être tenu responsable des dommages directs ou indirects résultant de l'utilisation ou de l'impossibilité d'utilisation de la plateforme, notamment en cas d'interruption de service, de perte de données ou d'intrusion.</p>
          </section>
